...
void PCA9685Servo::actuate(int intensity) {
  this->_pwm_driver.set_pwm(this->_pin,0,constrain(map(intensity,this->_min_limit,this->_max_limit,this->_min_mapping,this->_max_mapping),this->_min_mapping,this->_max_mapping));
}
